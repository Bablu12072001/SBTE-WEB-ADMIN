...
export default function EditCircularModal({ isOpen, setIsOpen, data, onSave }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.put("/api/admin/circular", formData, {
        headers: {
