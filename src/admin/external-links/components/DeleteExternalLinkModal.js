...
export default function DeleteExternalLinkModal({
  isOpen,
  setIsOpen,
  item,
  token,
  ...
  const handleDelete = async () => {
    try {
      const response = await axios.delete("/api/admin/external", {
        headers: {
      ...
      alert("Error deleting external link. Check console for details.");
    }
  };
