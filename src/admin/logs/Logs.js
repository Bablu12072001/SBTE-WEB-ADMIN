    ...
    <div className="flex h-screen">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between mb-1 lg:px-4 px-2">
          <p className="text-xl font-semibold text-gray-600">Activity Log</p>
        </div>

        {/* Tab Navigation */}
        <div className="flex gap-3 border-b lg:px-4 px-2">
          <button
            className={`py-2 ${
              activeTab === "files"
        ...
        <div className="lg:px-4 px-2 py-4">
          <div className="lg:px-4 px-2 py-4">
            {activeTab === "files" && <RecentLogs />}
            {activeTab === "table" && <AllLogs />}
          </div>
        </div>
      </div>
    </div>
