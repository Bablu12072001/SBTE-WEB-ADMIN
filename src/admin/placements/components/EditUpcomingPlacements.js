...
export default function EditUpcomingPlacements({
  isOpen,
  setIsOpen,
  placement,
  refreshData,
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.put("/api/admin/upcoming_placement", payload, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      ...
      if (res.data && res.data.status) {
        ...
        console.error("PUT /api/admin/upcoming_placement returned:", res.data);
        alert("Failed to update upcoming placement. See console for details.");
      }
    } catch (err) {
