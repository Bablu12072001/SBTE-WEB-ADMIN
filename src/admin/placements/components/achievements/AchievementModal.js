...
export default function AchievementModal({ isOpen, setIsOpen, onSuccess }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("/api/admin/achievement", payload, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      ...
      alert("Error submitting achievement. Check console for details.");
    }
  };
