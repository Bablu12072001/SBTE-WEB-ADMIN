...
export default function DeleteJobCarousel({ open, id, onCancel, onSuccess }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await axios.delete("/api/admin/job_carousel", {
        headers: {
      ...
      if (res.data && res.data.status) {
        ...
        console.error("DELETE /api/admin/job_carousel returned:", res.data);
    ...
    <Dialog open={open} onClose={onCancel} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="bg-white p-6 rounded-lg max-w-sm w-full shadow-xl">
          ...
          <p className="mt-2">
            Are you sure you want to delete this job carousel item?
          </p>
