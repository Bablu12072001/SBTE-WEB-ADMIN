...
export default function JobCarouselModal({ isOpen, setIsOpen, onSuccess }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("/api/admin/job_carousel", payload, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      ...
      console.error(
        "Error adding job carousel:",
        error.response?.data || error.message
      );
      alert("Error submitting job carousel. Check console for details.");
    }
  };
