...
export default function SuccessStoryModal({ isOpen, setIsOpen, onSuccess }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("/api/admin/stories", payload, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      ...
      alert("Error submitting success story. Check console for details.");
    }
  };
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="bg-white p-6 rounded-lg max-w-lg w-full shadow-xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm mb-1 font-medium">LPA</label>
              <input
                type="text"
                className="w-full border rounded px-3 py-2"
                value={LPA}
            ...
            <div>
              <label className="block text-sm mb-1 font-medium">Branch</label>
              <input
                type="text"
                className="w-full border rounded px-3 py-2"
                value={branch}
            ...
            <div>
              <label className="block text-sm mb-1 font-medium">Story</label>
              <textarea
                className="w-full border rounded px-3 py-2"
                value={text}
