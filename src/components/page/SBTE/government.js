...
const Government = () => {
  ...
  const [govTotalIntake, setGovTotalIntake] = useState(0);
  ...
  const fetchInstitutes = async (year) => {
    ...
    try {
      const response = await axios.get(
        `https://sbte-api.anantdrishti.com/util/getInstituteList?instituteType=GOVERNMENT&academicYear=${year}`
      );
      ...
      setInstitutes(data);
      setGovTotalIntake(body.govTotalIntake || 0);
    } catch (error) {
      ...
      >
        ...
        >
          <Typography sx={{ flex: 1, minWidth: "250px", textAlign: "left" }}>
            The list of all Government Institutes affiliated under SBTE Bihar
          </Typography>
        ...
        {loading ? (
            ...
            <Table size="small">
              ...
              <TableBody>
                ...
                <TableRow sx={{ backgroundColor: "#dff0d8" }}>
                  ...
                  >
                    Total Approved Intake (Government):
                  </TableCell>
          ...
          <Typography textAlign="center" p={3}>
            No Government institutes found for academic year {selectedYear}.
          </Typography>
        )}
      </Box>
    </>
